...
class Tabla2Activity : AppCompatActivity() {
    ...
    private fun encontrarCantidadesFos() {
        ...
        list[3].metionina =   (cantidad * (fosforoSeleccionada!!.metionina.toDouble() / 100)).toString()
        list[3].metCis =  (cantidad * (fosforoSeleccionada!!.met_cis.toDouble() / 100)).toString()
        //////////////////
        list[list.size-2].cantidad = (list[list.size-2].cantidad.toDouble()+list[3].cantidad.toDouble()).toString()
        list[list.size-2].proteina = (list[list.size-2].proteina.toDouble()+list[3].proteina.toDouble()).toString()
        list[list.size-2].fibra = (list[list.size-2].fibra.toDouble()+list[3].fibra.toDouble()).toString()
        list[list.size-2].energia = (list[list.size-2].energia.toDouble()+list[3].energia.toDouble()).toString()
        list[list.size-2].calcio = (list[list.size-2].calcio.toDouble()+list[3].calcio.toDouble()).toString()
        list[list.size-2].fosforo = (list[list.size-2].fosforo.toDouble()+list[3].fosforo.toDouble()).toString()
        list[list.size-2].lisina = (list[list.size-2].lisina.toDouble()+list[3].lisina.toDouble()).toString()
        list[list.size-2].metionina = (list[list.size-2].metionina.toDouble()+list[3].metionina.toDouble()).toString()
        list[list.size-2].metCis = (list[list.size-2].metCis.toDouble()+list[3].metCis.toDouble()).toString()
